...
The current release version is `0.1.4`.
...
sqldelight {
    databases {
        create("Database") {
            ...
            dialect("dev.s7a.sqldelight.oracle:sqldelight-oracle-dialect:0.1.4")
        }
    }
}
```
...
dependencies {
    sqldelightCheckDialects("dev.s7a.sqldelight.oracle:sqldelight-check-oracle-dialect:0.1.4")
    sqldelightCheckRuleSet("dev.s7a.sqldelight.oracle:sqldelight-check-oracle-rule:0.1.4")
}
```
