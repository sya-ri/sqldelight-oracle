...
sqldelight {
    databases {
        create("Database") {
            ...
            dialect("dev.s7a.sqldelight.oracle:sqldelight-oracle-dialect:0.1.5")
        }
    }
}
```
...
dependencies {
    sqldelightCheckDialects("dev.s7a.sqldelight.oracle:sqldelight-check-oracle-dialect:0.1.5")
    sqldelightCheckRuleSet("dev.s7a.sqldelight.oracle:sqldelight-check-oracle-rule:0.1.5")
}
```
