...
- [ ] `delete_stmt`: parser-backed coverage exists for partition and remote targets, `WHERE CURRENT OF`, `RETURNING`, and DML error logging; remaining work includes object-table and full `DML_table_expression_clause` coverage
