...
import dev.s7a.sqldelight.oracle.check.rule.rules.NoConflictingRoleClausesRule
...
import dev.s7a.sqldelight.oracle.check.rule.rules.ValidJsonTableClausesRule
...
public class OracleRuleSetProvider : RuleSetProvider {
    ...
    override fun ruleProviders(): Set<RuleProvider> =
        setOf(
            ...
            RuleProvider(::NoConflictingCommitWriteClausesRule),
            ...
            RuleProvider(::NoConflictingRollbackClausesRule),
            RuleProvider(::NoConflictingRoleClausesRule),
            RuleProvider(::NoConflictingSequenceClausesRule),
            RuleProvider(::NoConflictingSetRoleClausesRule),
            RuleProvider(::NoConflictingSetConstraintsClausesRule),
            RuleProvider(::NoConflictingSetTransactionClausesRule),
            ...
            RuleProvider(::ValidJsonTableClausesRule),
            RuleProvider(::ValidReturningClauseRule),
            RuleProvider(::ValidRowValueArityRule),
            RuleProvider(::ValidRowLimitingClauseRule),
            RuleProvider(::ValidLikeEscapeRule),
            RuleProvider(::ValidLockTableWaitClauseRule),
