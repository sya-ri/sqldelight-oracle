...
private val oracleFunctionArities =
    mapOf(
        ...
        "JSON_QUERY" to exactArity(2),
        "JSON_SCALAR" to exactArity(1),
        "JSON_SERIALIZE" to exactArity(1),
        "JSON_VALUE" to exactArity(2),
        ...
        "LENGTHB" to exactArity(1),
        "LENGTHC" to exactArity(1),
        "LENGTH2" to exactArity(1),
        "LENGTH4" to exactArity(1),
        ...
        "UNDER_PATH" to arityRange(2, Int.MAX_VALUE),
        ...
        "INSTRB" to arityRange(2, 4),
        "INSTRC" to arityRange(2, 4),
        ...
        "SUBSTRB" to arityRange(2, 3),
        "SUBSTRC" to arityRange(2, 3),
        "SUBSTR2" to arityRange(2, 3),
        "SUBSTR4" to arityRange(2, 3),
