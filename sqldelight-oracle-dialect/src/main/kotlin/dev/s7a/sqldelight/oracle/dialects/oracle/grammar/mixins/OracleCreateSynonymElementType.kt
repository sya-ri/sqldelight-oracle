...
import dev.s7a.sqldelight.oracle.dialects.oracle.grammar.psi.impl.OracleCreateUnqualifiedSynonymStmtImpl

internal class OracleCreateSynonymElementType(
    name: String,
    ...
    override fun createPsi(stub: SchemaContributorStub): OracleCreateUnqualifiedSynonymStmtImpl =
        OracleCreateUnqualifiedSynonymStmtImpl(stub, this)
}
